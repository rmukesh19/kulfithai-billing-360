                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2 border rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={newProduct.purchasePrice === 0 || newProduct.purchasePrice === '0' ? '' : newProduct.purchasePrice} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={newProduct.sellingPrice === 0 || newProduct.sellingPrice === '0' ? '' : newProduct.sellingPrice} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      step="any"
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border border-blue-100 rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={newProduct.mrp === 0 || newProduct.mrp === '0' ? '' : newProduct.mrp} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      step="any"
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border border-indigo-100 rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={newProduct.wholesalePrice === 0 || newProduct.wholesalePrice === '0' ? '' : newProduct.wholesalePrice} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={newProduct.openingStock === 0 || newProduct.openingStock === '0' ? '' : newProduct.openingStock} 
                      onChange={e => setNewProduct({...newProduct, openingStock: e.target.value, stock: e.target.value})} 
                      placeholder="0"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={editingProduct.purchasePrice === 0 || editingProduct.purchasePrice === '0' ? '' : (editingProduct.purchasePrice ?? '')} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={editingProduct.sellingPrice === 0 || editingProduct.sellingPrice === '0' ? '' : (editingProduct.sellingPrice ?? '')} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border border-blue-100 rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={editingProduct.mrp === 0 || editingProduct.mrp === '0' ? '' : (editingProduct.mrp ?? '')} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border border-indigo-100 rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={editingProduct.wholesalePrice === 0 || editingProduct.wholesalePrice === '0' ? '' : (editingProduct.wholesalePrice ?? '')} 
                  ...
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      onFocus={e => e.target.select()}
                      className="w-full px-4 py-2 border rounded-xl focus:border-blue-500 outline-none font-bold" 
                      value={editingProduct.stock === 0 || editingProduct.stock === '0' ? '' : (editingProduct.stock ?? '')} 
